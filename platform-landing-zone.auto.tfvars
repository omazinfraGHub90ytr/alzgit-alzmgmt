...
custom_replacements = {
  ...
  */
  names = {
    ...
    # IP Ranges Primary
    # Regional Address Space: 10.20.0.0/16
    primary_hub_address_space                          = "10.20.0.0/16"
    primary_hub_virtual_network_address_space          = "10.20.0.0/22"
    primary_nva_subnet_address_prefix                  = "10.20.0.0/26"
    primary_nva_ip_address                             = "10.20.0.4"
    primary_bastion_subnet_address_prefix              = "10.20.0.64/26"
    primary_gateway_subnet_address_prefix              = "10.20.0.128/27"
    primary_private_dns_resolver_subnet_address_prefix = "10.20.0.160/28"

    # IP Ranges Secondary
    # Regional Address Space: 10.21.0.0/16
    secondary_hub_address_space                          = "10.21.0.0/16"
    secondary_hub_virtual_network_address_space          = "10.21.0.0/22"
    secondary_nva_subnet_address_prefix                  = "10.21.0.0/26"
    secondary_nva_ip_address                             = "10.21.0.4"
    secondary_bastion_subnet_address_prefix              = "10.21.0.64/26"
    secondary_gateway_subnet_address_prefix              = "10.21.0.128/27"
    secondary_private_dns_resolver_subnet_address_prefix = "10.21.0.160/28"
  }
